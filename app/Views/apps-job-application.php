...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Application')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Jobs', 'title' => 'Application')); ?>
                                    ...
                                    <form>
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xxl-1 col-sm-4">
                                                <div>
                                                    <button type="button" class="btn btn-info w-100" onclick="filterData();"> <i class="ri-equalizer-fill me-1 align-bottom"></i>
                                                        Filters
                                                    </button>
                                                </div>
                                            </div>
