                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                ...
                                <div class="card-body p-0 pb-2">
                                    <div>
                                        <div id="customer_impression_charts" data-colors='["--vz-primary-rgb, 0.1", "--vz-primary", "--vz-primary-rgb, 0.6"]' class="apex-charts"></div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="apps-ecommerce-add-product" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                                    </div>
                                </div>
                                <div class="col-sm">
