<?= $this->include('partials/main') ?>
    ...
    <head>
        ...
        <?php echo view('partials/title-meta', array('title' => 'Job Dashboard')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php echo view('partials/page-title', array('pagetitle' => 'Dashboards', 'title' => 'Job Dashboard')); ?>
                            ...
                            <div class="col-xxl-8">
                                <div class="card card-height-100">
                                    ...
                                    <div class="card-body p-0 pb-2">
                                        <div class="w-100">
                                            <div id="line_chart_dashed" data-colors='["--vz-primary", "--vz-secondary", "--vz-success"]' class="apex-charts" dir="ltr"></div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div><!-- end col -->
