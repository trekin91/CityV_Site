                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <div id="sales-forecast-chart" data-colors='["--vz-primary-rgb, 0.75", "--vz-primary", "--vz-primary-rgb, 0.55"]' class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body pb-0">
                                    <div id="deal-type-charts" data-colors='["--vz-primary-rgb, 0.15", "--vz-primary-rgb, 0.35", "--vz-primary-rgb, 0.45"]' class="apex-charts" dir="ltr"></div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div id="revenue-expenses-charts" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                    </div><!-- end row -->
                                        ...
                                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-soft-primary p-2">New Lead</span></td>
                                                    <td>
