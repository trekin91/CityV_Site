<?= $this->include('partials/main') ?>
    ...
    <head>
        ...
        <?php echo view('partials/title-meta', array('title' => 'Job Lists')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php echo view('partials/page-title', array('pagetitle' => 'Jobs', 'title' => 'Job Lists')); ?>
                                ...
                                <div class="card job-list-view-card overflow-hidden" id="job-overview">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div>
                                                <div id="simple_dount_chart" data-colors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-danger"]' class="apex-charts" dir="ltr"></div>
                                            </div>
                                        </div>
                                        <div class="mt-4">
