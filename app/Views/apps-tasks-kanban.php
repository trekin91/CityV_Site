                                ...
                                <div id="unassigned-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Profile Page
                                                        Structure</a></h6>
                                                <div class="dropdown">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Velzon -
                                ...
                                <div id="todo-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Admin
                                                            Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Marketing &
                                                            Sales</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="reviews-task" class="tasks">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Create a Graph of Sketch</a></h6>
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="completed-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Create a Blog
                                                        Template UI</a></h6>
                                                <div class="dropdown">
