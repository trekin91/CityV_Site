                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-grow-1">
                                            <lord-icon src="https://cdn.lordicon.com/fhtaantg.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:55px;height:55px">
                                            </lord-icon>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">BTC</a>
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">ETH</a>
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">USD</a>
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">EUR</a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-grow-1">
                                            <lord-icon src="https://cdn.lordicon.com/qhviklyi.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:55px;height:55px"></lord-icon>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">BTC</a>
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">ETH</a>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-grow-1">
                                            <lord-icon src="https://cdn.lordicon.com/yeallgsa.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:55px;height:55px">
                                            </lord-icon>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="javascript:void(0);" class="badge badge-soft-secondary  badge-border">BTC</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card card-animate border-0 overflow-hidden">
                                            <div class="card-body bg-soft-primary">
                                                <div class="d-flex mb-3">
                                                    <div class="flex-grow-1">
                                                        <lord-icon src="https://cdn.lordicon.com/vaeagfzc.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:55px;height:55px">
                                                        </lord-icon>
                                                    </div>
                                                    <div class="flex-shrink-0">
                    ...
                    <div class="row align-items-center mb-4 g-3">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="d-flex gap-2">
                                <a href="javascript:void(0);" data-bs-toggle="modal" class="btn btn-soft-secondary">Deposite</a>
                                <a href="javascript:void(0);" data-bs-toggle="modal" class="btn btn-soft-success">Withdraw</a>
                            </div>
                        </div>
                        <!--end col-->
                    </div>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="status">
                                                <span class="badge badge-soft-primary fs-11"><i class="ri-time-line align-bottom"></i> Processing</span>
                                            </td>
                                        </tr>
                                        <!--end tr-->
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/assets/images/svg/crypto-icons/eur.svg" alt="" class="avatar-xxs me-2">
                                                    EUR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/assets/images/svg/crypto-icons/gbp.svg" alt="" class="avatar-xxs me-2">
                                                    GBP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/assets/images/svg/crypto-icons/jpy.svg" alt="" class="avatar-xxs me-2">
                                                    JPY
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/assets/images/svg/crypto-icons/xpm.svg" alt="" class="avatar-xxs me-2">
                                                    XPM
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/assets/images/svg/crypto-icons/ppt.svg" alt="" class="avatar-xxs me-2">
                                                    PPT
                                                </div>
                                            </td>
