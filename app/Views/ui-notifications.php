                                    ...
                                    <div class="live-preview">
                                        ...
                                        <div class="position-relative">
                                            <div class="hstack flex-wrap gap-2">
                                                ...
                                                <button type="button" class="btn btn-info" id="borderedTost3Btn">Warning Toast</button>
                                            ...
                                            <div style="z-index: 11">
                                                <div id="borderedTost3" class="toast toast-border-info overflow-hidden mt-3" role="alert" aria-live="assertive" aria-atomic="true">
                                                    <div class="toast-body">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
