<?= $this->include('partials/main') ?>
    ...
    <head>
        ...
        <?php echo view('partials/title-meta', array('title' => 'Statistics')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php echo view('partials/page-title', array('pagetitle' => 'Jobs', 'title' => 'Statistics')); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                <div class="card card-height-100">
                                    ...
                                    <div class="card-body">
                                        <div id="user_device_pie_charts" data-colors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.5"]' class="apex-charts" dir="ltr"></div>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                                                <tbody class="border-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-primary me-2"></i>Tablet Users</h4>
                                                        </td>
                                                        <td>
