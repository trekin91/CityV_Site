                                                    ...
                                                    <div class="col-md">
                                                        <div>
                                                            ...
                                                            <div class="hstack gap-3 flex-wrap">
                                                                ...
                                                                <div class="vr"></div>
                                                                <div class="badge rounded-pill bg-primary fs-12">New</div>
                                                                <div class="badge rounded-pill bg-success fs-12">High</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-3 col-lg-4">
                                            ...
                                            <div class="card">
                                                <div class="card-header align-items-center d-flex border-bottom-dashed">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <button type="button" class="btn btn-soft-primary btn-sm" data-bs-toggle="modal" data-bs-target="#inviteMembersModal"><i class="ri-share-line me-1 align-bottom"></i> Invite Member</button>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table table-borderless align-middle mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="dropdown">
                                                                            <a href="javascript:void(0);" class="btn btn-soft-primary btn-sm btn-icon" data-bs-toggle="dropdown" aria-expanded="true">
                                                                                <i class="ri-more-fill"></i>
                                                                            </a>
                                            ...
                                            <div class="acitivity-timeline py-3">
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted mb-2"><span class="text-danger">2 days left</span> notification to submit the monthly sales report. <a href="javascript:void(0);" class="link-primary text-decoration-underline">Reports Builder</a></p>
