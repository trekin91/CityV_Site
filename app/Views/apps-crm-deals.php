                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-auto ms-auto">
                                    <div class="d-flex hastck gap-2 flex-wrap">
                                        ...
                                        <button data-bs-toggle="modal" data-bs-target="#adddeals" class="btn btn-primary"><i class="ri-add-fill align-bottom me-1"></i> Add
                                            Deals</button>
                                        <div class="dropdown">
                                            <button class="btn btn-soft-secondary btn-icon fs-14" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        <div class="col">
                            <div class="card border-0 overflow-hidden">
                                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#leadDiscovered" role="button" aria-expanded="false" aria-controls="leadDiscovered">
                            ...
                            <div class="collapse show" id="leadDiscovered">
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="leadDiscovered1">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-primary">4 Days</small></h6>
                        ...
                        <div class="col">
                            <div class="card border-0 overflow-hidden">
                                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#contactInitiated" role="button" aria-expanded="false" aria-controls="contactInitiated">
                            ...
                            <div class="collapse show" id="contactInitiated">
                                ...
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="contactInitiated2">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Zoetic Fashion <small class="badge badge-soft-success">25 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                        ...
                        <div class="col">
                            <div class="card border-0 overflow-hidden">
                                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#needsIdentified" role="button" aria-expanded="false" aria-controls="needsIdentified">
                            ...
                            <div class="collapse show" id="needsIdentified">
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified1">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Alexis Clarke <small class="badge badge-soft-primary">7 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                                ...
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified2">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Meta4Systems <small class="badge badge-soft-success">35 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                                ...
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified3">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Syntyce Solutions <small class="badge badge-soft-primary">15 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified4">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Themesbrand <small class="badge badge-soft-primary">3
                                                    Month</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                ...
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="needsIdentified6">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">iTest Factory <small class="badge badge-soft-primary">42 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                        ...
                        <div class="col">
                            <div class="card border-0 overflow-hidden">
                                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#meetingArranged" role="button" aria-expanded="false" aria-controls="meetingArranged">
                            ...
                            <div class="collapse show" id="meetingArranged">
                                <div class="card mb-1">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="meetingArranged1">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-primary">10 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
                        ...
                        <div class="col">
                            <div class="card border-0 overflow-hidden">
                                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#offerAccepted" role="button" aria-expanded="false" aria-controls="offerAccepted">
                            ...
                            <div class="collapse show" id="offerAccepted">
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="collapse border-top border-top-dashed" id="offerAccepted2">
                                        <div class="card-body">
                                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-success">47 Days</small></h6>
                                            <p class="text-muted">As a company grows however, you find it's not as easy
                                                to shout across</p>
                                            <ul class="list-unstyled vstack gap-2 mb-0">
                                                <li>
