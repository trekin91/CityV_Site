                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-lg-auto">
                                    <div class="hstack gap-2">
                                        ...
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSeller"><i class="ri-add-fill me-1 align-bottom"></i> Add Seller</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Force Medicines</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Micro Design</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Nesta Technologies</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">iTest Factory</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Meta4Systems</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Digitech Galaxy</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card ribbon-box right overflow-hidden">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Syntyce Solutions</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details" class="link-secondary">Zoetic Fashion</a></h5>
                                        ...
                                        <div class="tab-pane" id="bankDetails" role="tabpanel">
                                            <form action="#">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <button class="btn btn-link link-priamry text-decoration-none fw-medium" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Close</button>
                                                            <button type="submit" class="btn btn-primary"><i class="ri-save-3-line align-bottom me-1"></i> Save</button>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
