                        ...
                        <div class="col-xxl-9">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body p-0 pb-3">
                                    <div id="Market_chart" data-colors='["--vz-primary", "--vz-success"]' class="apex-charts" dir="ltr"></div>
                                </div><!-- end cardbody -->
                            </div><!-- end card -->
                        </div>
                        <!--end col-->
                                    ...
                                    <div class="tab-content text-muted">
                                        ...
                                        <div class="tab-pane" id="cryptoSell" role="tabpanel">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <button type="button" class="btn btn-primary w-100">Sell Coin</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end tab-pane-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <a href="javascript:void(0);" class="currency_name link-secondary">Solana (SOL)</a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <a href="javascript:void(0);" class="currency_name link-secondary">Aragon (ANT)</a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <a href="javascript:void(0);" class="currency_name link-secondary">Filecoin (FIL)</a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <a href="javascript:void(0);" class="currency_name link-secondary">Cardano (ADA)</a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <a href="javascript:void(0);" class="currency_name link-secondary">Polkadot (DOT)</a>
                                                </div>
                                            </td>
