                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="javascript:void(0);" class="card-link">Bookmark <i class="ri-bookmark-line align-middle ms-1 lh-1"></i></a>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="row">
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card card-body">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-soft-primary">Apply Now</a>
                                    </div>
                                </div><!-- end col -->
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card card-body text-center">
                                        ...
                                        <p class="card-text text-muted">Send a link to apply on mobile device. Appropriately communicate one-to-one technology.</p>
                                        <a href="javascript:void(0);" class="btn btn-soft-primary">Add New</a>
                                    </div>
                                </div><!-- end col -->
                                <div class="col-xxl-4 col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <a href="javascript:void(0);" class="link-primary float-end">Read More <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <a href="javascript:void(0);" class="link-primary float-end">Payment Now <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        <a href="javascript:void(0)" class="btn btn-link btn-sm"><i class="ri-close-line align-middle lh-1"></i> Close</a>
                            ...
                            <div class="row" data-masonry='{"percentPosition": true }'>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <a href="javascript:void(0);" class="float-end">Read More <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                                            <p class="text-muted mb-0">1 days Ago</p>
                                        </div>
                                    </div>
                                </div><!-- end col -->
