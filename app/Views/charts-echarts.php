                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-line-stacked" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-secondary", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-area-stacked" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-light", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-step-line" data-colors='["--vz-primary", "--vz-gray-300", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-bar-label-rotation" data-colors='["--vz-primary", "--vz-info", "--vz-success", "--vz-gray-300"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-horizontal-bar-stacked" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-pie" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-doughnut" data-colors='["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.70", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.45"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="chart-funnel" data-colors='["--vz-primary", "--vz-secondary, "--vz-info", "--vz-success", "--vz-wrning"]' class="e-charts"></div>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
