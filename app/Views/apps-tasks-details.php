                        ...
                        <div class="col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <div class="mb-2">
                                        <lord-icon src="https://cdn.lordicon.com/kbtmbyzy.json" trigger="loop" colors="primary:#25a0e2,secondary:#00bd9d" style="width:90px;height:90px">
                                        </lord-icon>
                                    </div>
                                    <h3 class="mb-1">9 hrs 13 min</h3>
                                    <h5 class="fs-14 mb-4">Profile Page Satructure</h5>
                                    <div class="hstack gap-2 justify-content-center">
                                        <button class="btn btn-primary btn-sm"><i class="ri-stop-circle-line align-bottom me-1"></i> Stop</button>
                                        <button class="btn btn-soft-secondary btn-sm"><i class="ri-play-circle-line align-bottom me-1"></i> Start</button>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                                        ...
                                        <table class="table mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-soft-primary">High</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">Status</td>
                                                    <td><span class="badge badge-soft-success">Inprogress</span></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <ul class="list-unstyled vstack gap-3 mb-0">
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="mb-1"><a href="pages-profile" class="link-secondary">Tonya Noble</a></h6>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="mb-1"><a href="pages-profile" class="link-secondary">Thomas Taylor</a></h6>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="mb-1"><a href="pages-profile" class="link-secondary">Nancy Martino</a></h6>
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            ...
                                            <div class="hstack flex-wrap gap-2 fs-15">
                                                ...
                                                <div class="badge fw-medium badge-soft-secondary">Dashboard</div>
                                                <div class="badge fw-medium badge-soft-secondary">Design</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
