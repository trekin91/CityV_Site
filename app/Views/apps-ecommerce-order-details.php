                    ...
                    <div class="row">
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="apps-invoices-details" class="btn btn-secondary btn-sm"><i class="ri-download-2-fill align-middle me-1"></i> Invoice</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-16"><a href="apps-ecommerce-product-details" class="link-primary">Sweatshirt for Men
                                                                        (Pink)</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-16"><a href="apps-ecommerce-product-details" class="link-primary">Noise NoiseFit Endure Smart
                                                                        Watch</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-16"><a href="apps-ecommerce-product-details" class="link-primary">350 ml Glass Grocery
                                                                        Container</a></h5>
                                ...
                                <div class="card-header">
                                    <div class="d-sm-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 mt-2 mt-sm-0">
                                            <a href="javasccript:void(0;)" class="btn btn-soft-info btn-sm mt-2 mt-sm-0"><i class="ri-map-pin-line align-bottom me-1"></i> Change Address</a>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex">
                                        <h5 class="card-title flex-grow-1 mb-0"><i class="mdi mdi-truck-fast-outline align-middle me-1 text-muted"></i>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <lord-icon src="https://cdn.lordicon.com/uetqnvvg.json" trigger="loop" colors="primary:#405189,secondary:#0ab39c" style="width:80px;height:80px">
                                        </lord-icon>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><i class="ri-map-pin-line align-middle me-1 text-muted"></i> Billing Address
                                    </h5>
                                </div>
                                <div class="card-body">
