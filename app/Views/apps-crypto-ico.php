                    ...
                    <div class="row">
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-success mb-0"><i class="ri-time-line align-bottom"></i> 05 Days</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            <div class="card mb-2">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-success mb-0"><i class="ri-time-line align-bottom"></i> 15 Days</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            <div class="card mb-2">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 25 Jan, 2022</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            <div class="card mb-2">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 04 Feb, 2022</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                        ...
                        <div class="col-xxl-3 col-md-6">
                            ...
                            <div class="card mb-2 ribbon-box ribbon-fill right">
                                <div class="ribbon ribbon-primary shadow-none"><i class="ri-flashlight-fill me-1"></i> 1</div>
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 16 Feb, 2022</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            <div class="card mb-2 ribbon-box ribbon-fill right">
                                <div class="ribbon ribbon-primary shadow-none"><i class="ri-flashlight-fill me-1"></i> 2</div>
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 23 Jan, 2022</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            <div class="card mb-2 ribbon-box ribbon-fill right">
                                <div class="ribbon ribbon-primary shadow-none"><i class="ri-flashlight-fill me-1"></i> 3</div>
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 30 Dec, 2021</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                            <div class="card ribbon-box ribbon-fill right">
                                <div class="ribbon ribbon-primary shadow-none"><i class="ri-flashlight-fill me-1"></i> 4</div>
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                ...
                                <div class="card-body border-top border-top-dashed">
                                    <div class="d-flex">
                                        ...
                                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 02 Dec, 2021</h6>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
