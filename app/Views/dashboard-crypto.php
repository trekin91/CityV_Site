...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Crypto Dashboard')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Dashboards', 'title' => 'Crypto')); ?>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <p class="fs-13 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-primary me-1"></i>BTC
                                                    </p>
                                                </div>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <p class="fs-13 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-info me-1"></i>ETH
                                                    </p>
                                                </div>
                                                <div class="flex-shrink-0 text-end">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <p class="fs-13 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-warning me-1"></i>LTC
                                                    </p>
                                                </div>
                                                <div class="flex-shrink-0 text-end">
                                        ...
                                        <li class="list-group-item px-0 pb-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    ...
                                                    <p class="fs-13 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-success me-1"></i>DASH
                                                    </p>
                                                </div>
                                                <div class="flex-shrink-0 text-end">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-6">
                                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                                ...
                                                                <p class="fw-medium text-muted mb-0">$75.69 <span class="text-success fs-13 ms-1">+1.99%</span>
                                                                </p>
                                                                <p class="fw-medium text-muted mb-0">High <span class="text-dark fs-13 ms-1">0.014578</span></p>
                                                                <p class="fw-medium text-muted mb-0">Low <span class="text-dark fs-13 ms-1">0.0175489</span>
                                                                </p>
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+13.11%<span class="text-muted ms-2 text-uppercase">(btc)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+15.08%<span class="text-muted ms-2 text-uppercase">(ltc)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+08.57%<span class="text-muted ms-2 text-uppercase">(etc)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fs-13 fw-medium mb-0">-09.21%<span class="text-muted ms-2 text-uppercase">(bnb)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+12.07%<span class="text-muted ms-2 text-uppercase">(dash)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+14.99%<span class="text-muted ms-2 text-uppercase">(usdt)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fs-13 fw-medium mb-0">-05.07%<span class="text-muted ms-2 text-uppercase">(neo)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                        ...
                                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$48,568.025</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>5.26
                                                        </h6>
                                                    </td>
                                                    <td>$53,914.025</td>
                                                    <td>1.25634801</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$87,142.027</td>
                                                    <td>
                                                        <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>3.07
                                                        </h6>
                                                    </td>
                                                    <td>$75,854.127</td>
                                                    <td>2.85472161</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$33,847.961</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>7.13
                                                        </h6>
                                                    </td>
                                                    <td>$44,152.185</td>
                                                    <td>1.45612347</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$73,654.421</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.97
                                                        </h6>
                                                    </td>
                                                    <td>$48,367.125</td>
                                                    <td>0.35734601</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$66,742.077</td>
                                                    <td>
                                                        <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>1.08
                                                        </h6>
                                                    </td>
                                                    <td>$53,487.083</td>
                                                    <td>3.62912570</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$34,736.209</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>4.52
                                                        </h6>
                                                    </td>
                                                    <td>$15,203.347</td>
                                                    <td>1.85412740</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$56,357.313</td>
                                                    <td>
                                                        <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>2.87
                                                        </h6>
                                                    </td>
                                                    <td>$61,843.173</td>
                                                    <td>1.87732061</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$62,357.649</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.45
                                                        </h6>
                                                    </td>
                                                    <td>$54,843.173</td>
                                                    <td>0.95632087</td>
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="dropdown card-header-dropdown">
                                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="fw-semibold text-uppercase fs-13">Sort by: </span><span class="text-muted">Current Week<i class="mdi mdi-chevron-down ms-1"></i></span>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
