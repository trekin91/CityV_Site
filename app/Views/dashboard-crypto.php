                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0 pb-3">
                                                <div id="Market_chart" data-colors='["--vz-success-rgb, 0.75", "--vz-danger-rgb, 0.75"]' class="apex-charts" dir="ltr"></div>
                                            </div><!-- end cardbody -->
                                        </div><!-- end card -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                        ...
                                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$53,914.025</td>
                                                    <td>1.25634801</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-primary">Trade</a></td>
                                                </tr><!-- end -->
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
