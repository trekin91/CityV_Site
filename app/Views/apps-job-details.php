...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Job Overview')); ?>
                        ...
                        <div class="col-xxl-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <button type="button" class="btn btn-icon btn-soft-danger float-end" data-bs-toggle="button" aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></button>
