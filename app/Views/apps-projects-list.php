                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="apps-projects-create" class="btn btn-soft-secondary"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                            </div>
                        </div>
                        <div class="col-sm">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview" class="text-dark">Slack brand logo design</a></h5>
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <div class="progress progress-sm animated-progress">
                                                <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100" style="width: 34%;">
                                                </div><!-- /.progress-bar -->
                                            </div><!-- /.progress -->
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview" class="text-dark">Redesign - Landing page</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview" class="text-dark">Chat Application</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-soft-primary rounded p-2">
                                                        <img src="/assets/images/brands/dropbox.png" alt="" class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview" class="text-dark">Project App</a></h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview" class="text-dark">Multipurpose landing template</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-warning rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview" class="text-dark">Dashboard UI</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                                    <button type="button" class="btn avatar-xs p-0 favourite-btn active">
                                    ...
                                    <div>
                                        ...
                                        <div class="progress progress-sm animated-progress">
                                            <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 95%;">
                                            </div><!-- /.progress-bar -->
                                        </div><!-- /.progress -->
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-primary rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview" class="text-dark">Vector Images</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                    ...
                                    <div>
                                        ...
                                        <div class="progress progress-sm animated-progress">
                                            <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="41" aria-valuemin="0" aria-valuemax="100" style="width: 41%;">
                                            </div><!-- /.progress-bar -->
                                        </div><!-- /.progress -->
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-success rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview" class="text-dark">Authentication</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                                    <button type="button" class="btn avatar-xs p-0 favourite-btn active">
                                    ...
                                    <div>
                                        ...
                                        <div class="progress progress-sm animated-progress">
                                            <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style="width: 35%;">
                                            </div><!-- /.progress-bar -->
                                        </div><!-- /.progress -->
                                    </div>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="fs-14 mb-3"><a href="apps-projects-overview" class="text-dark">Kanban Board</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-dark">Ecommerce app</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-dark">Redesign - Landing page</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-dark">Multipurpose landing template</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
