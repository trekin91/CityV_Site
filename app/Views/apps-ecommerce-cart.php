                    ...
                    <div class="row mb-3">
                        <div class="col-xl-8">
                            ...
                            <div class="text-end mb-4">
                                <a href="apps-ecommerce-checkout" class="btn btn-primary btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout</a>
                            </div>
                        </div>
                        <!-- end col -->
                            ...
                            <div class="sticky-side-div">
                                ...
                                <div class="alert border-dashed alert-primary" role="alert">
                                    <div class="d-flex align-items-center">
                                        <lord-icon src="https://cdn.lordicon.com/nkmsrxys.json" trigger="loop" colors="primary:#121331,secondary:#25a0e2" style="width:80px;height:80px">
                                        </lord-icon>
                                        <div class="ms-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <button type="button" class="btn w-sm btn-primary" id="remove-product">Yes, Delete It!</button>
                    </div>
                </div>
