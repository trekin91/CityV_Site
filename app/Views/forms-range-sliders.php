                                        ...
                                        <div>
                                            ...
                                            <div class="my-4">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div data-multielement data-slider-color="primary"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row -->
                                            </div>
                                            ...
                                            <div class="my-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        ...
                                                        <div id="html5" data-slider-color="primary"></div>
                                            ...
                                            <div class="my-4">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="slider" id="slider-merging-tooltips" data-slider-color="primary"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row -->
                                            </div>
                                            ...
                                            <div class="my-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="slider" id="slider-hide" data-slider-color="primary"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row-->
                                            </div>
                                            ...
                                            <div class="mt-4 mb-5">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="slider" id="slider-pips" data-slider-color="primary"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row-->
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6">
                                            <div>
                                                ...
                                                <div data-rangeslider data-slider-size="lg" data-slider-color="primary"></div>
                                            </div>
                                        </div>
                                        <!-- end col -->
                                        <div class="col-xl-4 col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                ...
                                                <div data-rangeslider data-slider-size="md" data-slider-color="primary"></div>
                                            </div>
                                        </div>
                                        <!-- end col -->
                                        ...
                                        <div class="col-xl-4 col-lg-6">
                                            <div class="mt-4 mt-xl-0">
                                                ...
                                                <div data-rangeslider data-slider-size="sm" data-slider-color="primary"></div>
                                            </div>
                                        </div>
                                        <!-- end col -->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <div data-rangeslider data-slider-style="line" data-slider-color="primary"></div>
                                            </div>
                                        </div>
                                        <!-- end col -->
                                        <div class="col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                ...
                                                <div data-rangeslider data-slider-style="border" data-slider-color="primary"></div>
                                            </div>
                                        </div>
                                        <!-- end col -->
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-6">
                                                <div class="mt-4">
                                                    ...
                                                    <div data-rangeslider data-slider-style="square" data-slider-color="primary"></div>
                                                </div>
                                            </div>
                                            <!-- end col -->
                                        </div>
